    ...
    return (
        <div>
            ...
            <div>
                ...
                <br />
                <br />
                <Link to="/"><button className="btn btn-secondary mr-1"><i class="bi bi-x-square"></i>Cancel</button></Link>
                <button type="submit" className="btn btn-primary" onClick={handleSubmit}><i class="bi bi-save"></i>Submit</button>
            </div>
        </div>
    )
}
